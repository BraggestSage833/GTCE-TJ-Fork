            ...
            if (!material.hasFlag(Material.MatFlags.FLAMMABLE | MatFlags.NO_SMELTING)) {
                ...
                if (metalMaterial.blastFurnaceTemperature <= 0) {
                    ...
                    BlastRecipeBuilder ingotSmeltingBuilder = RecipeMaps.BLAST_RECIPES.recipeBuilder()
                            ...
                            .duration(duration).EUt(getTieredVoltageMultiplier(material));
                    ...
                    if (!hasHotIngot) {
                        BlastRecipeBuilder nuggetSmeltingBuilder = RecipeMaps.BLAST_RECIPES.recipeBuilder()
                                ...
                                .outputs(nuggetStack)
                                .blastFurnaceTemp(metalMaterial.blastFurnaceTemperature)
                                .duration(Math.max(1, duration / 9)).EUt(getTieredVoltageMultiplier(material));
                        if (circuitRequiringMaterials.contains(material)) {
    ...
    public static void processIngot(OrePrefix ingotPrefix, IngotMaterial material) {
        ...
        if (material.shouldGenerateFluid()) {
            RecipeMaps.FLUID_SOLIDFICATION_RECIPES.recipeBuilder()
                    ...
                    .duration(20).EUt(getTieredVoltageMultiplier(material))
                    .buildAndRegister();
        }
        ...
        if (material.hasFlag(NO_SMASHING)) {
            RecipeMaps.EXTRUDER_RECIPES.recipeBuilder()
                    ...
                    .duration(10).EUt(getTieredVoltageMultiplier(material))
                    .buildAndRegister();
        }
        ...
        if (material.hasFlag(MatFlags.GENERATE_PLATE) && !material.hasFlag(NO_SMASHING)) {
            ...
            RecipeMaps.BENDER_RECIPES.recipeBuilder()
                    ...
                    .input(ingotPrefix, material)
                    .outputs(plateStack)
                    .EUt(getTieredVoltageMultiplier(material)).duration((int) (material.getAverageMass()))
                    .buildAndRegister();

            RecipeMaps.FORGE_HAMMER_RECIPES.recipeBuilder()
                    .input(ingotPrefix, material, 3)
                    .outputs(GTUtility.copyAmount(2, plateStack))
                    .EUt(getTieredVoltageMultiplier(material)).duration((int) (material.getAverageMass() * 2))
                    .buildAndRegister();
            ...
            RecipeMaps.EXTRUDER_RECIPES.recipeBuilder()
                    ...
                    .outputs(OreDictUnifier.get(OrePrefix.plate, material))
                    .duration((int) material.getAverageMass()).EUt(getTieredVoltageMultiplier(material))
                    .buildAndRegister();
            ...
            if (material.hasFlag(IngotMaterial.MatFlags.GENERATE_DENSE)) {
                ...
                RecipeMaps.BENDER_RECIPES.recipeBuilder()
                        ...
                        .outputs(denseStack)
                        .circuitMeta(5)
                        .EUt(getTieredVoltageMultiplier(material)).duration((int) (material.getAverageMass() * 9))
                        .buildAndRegister();
            }
        }
            ...
            if (material.hasFlag(MatFlags.GENERATE_PLATE)) {
                if (material instanceof IngotMaterial) {
                    ...
                    RecipeMaps.FLUID_SOLIDFICATION_RECIPES.recipeBuilder()
                            ...
                            .fluidInputs(material.getFluid((int) (materialAmount * L / M)))
                            .outputs(blockStack)
                            .duration((int) material.getAverageMass()).EUt(30)
                            .buildAndRegister();
            } else {
                RecipeMaps.FLUID_SOLIDFICATION_RECIPES.recipeBuilder()
                        .notConsumable(MetaItems.SHAPE_MOLD_BLOCK)
        ...
        if (material.hasFlag(MatFlags.GENERATE_PLATE)) {
            if (material instanceof IngotMaterial) {
                ...
                RecipeMaps.CUTTER_RECIPES.recipeBuilder()
                        ...
                        .duration((int) (material.getAverageMass() * 8L)).EUt(getTieredVoltageMultiplier(material))
                        .buildAndRegister();
            } else {
                ItemStack plateStack = OreDictUnifier.get(OrePrefix.plate, material);
                RecipeMaps.CUTTER_RECIPES.recipeBuilder()
        ...
        if (!material.hasFlag(EXCLUDE_BLOCK_CRAFTING_RECIPES)) {
            ...
            if (material instanceof IngotMaterial) {
                ...
                RecipeMaps.ALLOY_SMELTER_RECIPES.recipeBuilder()
                        ...
                        .notConsumable(MetaItems.SHAPE_MOLD_BLOCK)
                        .outputs(blockStack)
                        .duration(5).EUt(getTieredVoltageMultiplier(material))
                        .buildAndRegister();
            }
        }
    }
